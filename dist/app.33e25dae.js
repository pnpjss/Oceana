...
},{"./invites.json":"4b743e59f6da7136c12b92baa9645fed","prettier":"919a603bafe8a70f6324346cc3592c6c"}],"4b743e59f6da7136c12b92baa9645fed":[function(require,module,exports) {
...
},{}],"919a603bafe8a70f6324346cc3592c6c":[function(require,module,exports) {
var define;
var global = arguments[3];
!function (e, t) {
  ...
  var Z = {
    ...
    dedent: function (e) {
      ...
      ee = e => "string" == typeof e ? e.replace((({
    onlyFirst: e = !1
  } = {}) => {
  ...
  var gt = {
    getSupportInfo: function ({
      ...
      const u = ht.split("-", 1)[0],
            ...
            a = ((e, t) => Object.entries(e).map(([e, n]) => Object.assign({
        [t]: e
      }, n)))(Object.assign({}, ...t.map(({
        options: e
      }) => e), mt), "name").filter(e => s(e) && c(e)).sort((e, t) => e.name === t.name ? 0 : e.name < t.name ? -1 : 1).map(function (t) {
        if (o) return t;
    ...
    inferParserByLanguage: function (e, t) {
      const {
        ...
        plugins: t.plugins
            ...
            r = n.find(({
        name: t
      }) => t.toLowerCase() === e) || n.find(({
        aliases: t
      }) => Array.isArray(t) && t.includes(e)) || n.find(({
        extensions: t
  ...
  var Gt = {
    printDocToString: function (e, t) {
      ...
      if (-1 !== c) {
        const e = i.indexOf($t.placeholder, c + 1),
              t = i.slice(0, c).join(""),
  ...
  function Qt(e, t, n, r) {
    ...
    for (; 0 !== o.length;) {
      ...
      if (e !== Kt) {
        if (n && o.push(e, Kt), !t || !1 !== t(e)) if ("concat" === e.type || "fill" === e.type) for (let t = e.parts.length - 1; t >= 0; --t) o.push(e.parts[t]);else if ("if-break" === e.type) e.flatContents && o.push(e.flatContents), e.breakContents && o.push(e.breakContents);else if ("group" === e.type && e.expandedStates) {
          if (r) for (let t = e.expandedStates.length - 1; t >= 0; --t) o.push(e.expandedStates[t]);else o.push(e.contents);
  ...
  var no = (e, t) => {
    ...
    for (const e of Object.keys(Vr.color.ansi)) o.has(e) || (u[e] = {
      get() {
        const t = this.level;
        return function () {
          const n = Vr.color[r[t]][e].apply(null, arguments),
                o = {
            open: n,
    ...
    for (const e of Object.keys(Vr.bgColor.ansi)) {
      ...
      u["bg" + e[0].toUpperCase() + e.slice(1)] = {
        get() {
          const t = this.level;
          return function () {
            const n = Vr.bgColor[r[t]][e].apply(null, arguments),
                  o = {
              open: n,
    ...
    class n extends ho.Schema {
      ...
      expected({
        ...
        const t = Array.from(this._choices.keys()).map(e => this._choices.get(e)).filter(e => !e.deprecated).map(e => e.value).sort(Eo.comparePrimitive).map(e.value),
              n = t.slice(0, -2),
              r = t.slice(-2);
    ...
    class n {
      constructor(e, t) {
        const {
          logger: n = console,
          descriptor: r = xo.defaultDescriptor,
          unknown: o = xo.defaultUnknownHandler,
          invalid: u = xo.defaultInvalidHandler,
          deprecated: i = xo.defaultDeprecatedHandler
        } = t || {};
        this._utils = {
          descriptor: r,
          logger: n || {
      ...
      _applyNormalization(e, t) {
        const n = [],
              [r, o] = Eo.partition(Object.keys(e), e => e in this._utils.schemas);

        for (const o of r) {
          const r = this._utils.schemas[o],
                u = r.preprocess(e[o], this._utils),
                i = Eo.normalizeValidateResult(r.validate(u, this._utils), u);

          if (!0 !== i) {
            const {
              value: e
            } = i,
                  t = this._invalidHandler(o, e, this._utils);
          ...
          const a = ({
            ...
            if (!1 !== n) if (!0 === n) this._hasDeprecationWarned(o) || this._utils.logger.warn(this._deprecatedHandler(o, t, this._utils));else for (const {
              value: e
            } of n) {
              const n = {
                key: o,
  ...
  const {
    ...
    stderr: cu
        ...
        {
    stringReplaceAll: lu,
    stringEncaseCRLFWithFirstIndex: pu
  } = Ko,
        {
    isArray: du
  } = Array,
  ...
  var wu = function (e, t) {
    ...
    return e;
      ...
      Tu = "object" == typeof Me && Me && Me.Object === Object && Me,
      Bu = "object" == typeof self && self && self.Object === Object && self,
  ...
  const Ku = {
    ...
    pair: ({
      key: e,
      value: t
    }) => !1 === t ? "--no-".concat(e) : !0 === t ? Ku.key(e) : "" === t ? "".concat(Ku.key(e), " without an argument") : "".concat(Ku.key(e), "=").concat(t)
  };
  ...
  var Ii = (e, t) => {
    ...
    for (const e of Object.keys(Ci.color.ansi)) o.has(e) || (u[e] = {
      get() {
        const t = this.level;
        return function () {
          const n = Ci.color[r[t]][e].apply(null, arguments),
                o = {
            open: n,
    ...
    for (const e of Object.keys(Ci.bgColor.ansi)) {
      ...
      u["bg" + e[0].toUpperCase() + e.slice(1)] = {
        get() {
          const t = this.level;
          return function () {
            const n = Ci.bgColor[r[t]][e].apply(null, arguments),
                  o = {
              open: n,
  ...
  var zi = {
    parse: function (e, t) {
      const n = Ui(t),
            r = Object.keys(n).reduce((e, t) => Object.defineProperty(e, t, {
        enumerable: !0,
        get: () => n[t].parse
      }), {}),
            o = Ji(t, n);
  ...
  function Ki(e, t) {
    const n = _i.basename(e).toLowerCase(),
          r = Gi({
      plugins: t
    ...
    if (!o && !n.includes(".")) {
      const t = function (e) {
        ...
        try {
          const e = new Dr(t).next().toString("utf8"),
    ...
    normalize: function (e, t) {
      ...
      const n = Object.assign({}, e),
        ...
        showDeprecated: !0
            ...
            o = Object.assign({}, Yi, yr(r.filter(e => void 0 !== e.default).map(e => [e.name, e.default])));
  ...
  const {
    ...
    skipNewline: pa,
    skipSpaces: da,
    isPreviousLineEmpty: fa,
    addLeadingComment: ha,
    addDanglingComment: ma,
    addTrailingComment: ga
  } = Lt,
      ...
      e.forEach((a, s) => {
        ...
        const {
          ...
          followingNode: p
              ...
              d = r.printer.handleComments && r.printer.handleComments.ownLine ? r.printer.handleComments.ownLine : () => !1,
              f = r.printer.handleComments && r.printer.handleComments.endOfLine ? r.printer.handleComments.endOfLine : () => !1,
              h = r.printer.handleComments && r.printer.handleComments.remaining ? r.printer.handleComments.remaining : () => !1,
              m = e.length - 1 === s;
        if (la(n, u(a), {
          backwards: !0
  ...
  var Na = {
    printSubtree: function (e, t, n, r) {
      if (n.printer.embed && "auto" === n.embeddedLanguageFormatting) return n.printer.embed(e, t, (e, t, o) => function (e, t, n, r, {
        stripTrailingHardline: o = !1
      } = {}) {
  ...
  const $a = new Set(["ObjectExpression", "ArrayExpression", "StringLiteral", "NumericLiteral", "BooleanLiteral", "NullLiteral"]),
  ...
  const {
    ...
    getAlignmentSize: Ha
        ...
        {
    guessEndOfLine: Ga,
    convertEndOfLineToChars: Xa,
    countEndOfLineChars: Ya,
    normalizeEndOfLine: Ka
  } = Mt,
        Qa = Qi.normalize,
        Za = Symbol("cursor");
  ...
  const {
    getLast: Tc,
    hasNewline: Bc,
    getNextNonSpaceNonCommentCharacterIndexWithStartIndex: Nc,
    getNextNonSpaceNonCommentCharacter: kc,
    hasNewlineInRange: Pc,
    addLeadingComment: Oc,
    addTrailingComment: Ic,
    addDanglingComment: Lc,
    getNextNonSpaceNonCommentCharacterIndex: Mc
  } = Lt,
        {
    isBlockComment: jc,
    getFunctionParameters: _c,
    isPrettierIgnoreComment: Rc,
    isJSXNode: Vc,
    hasFlowShorthandAnnotationComment: $c,
    hasFlowAnnotationComment: qc,
    hasIgnoreComment: Wc
  } = wc,
        {
    locStart: Uc,
  ...
  const {
    ...
    builders: {
      ...
      indent: hl,
      align: ml,
      lineSuffixBoundary: gl,
      addAlignmentToDoc: Dl
    },
    printer: {
      printDocToString: yl
    },
    utils: {
      mapDoc: El
        ...
        {
    isBinaryish: Cl,
    isJestEachTemplateLiteral: bl,
    isSimpleTemplateLiteral: vl
  } = wc;
      ...
      if ("TemplateLiteral" === r.type && bl(r, e.getParentNode())) {
        const r = function (e, t, n) {
          ...
          if (o.length > 1 || o.some(e => 0 !== e.length)) {
            ...
            t.__inJestEach = !1;
            const i = [],
                  a = u.map(e => "${" + yl(e, Object.assign({}, t, {
              printWidth: 1 / 0,
              endOfLine: "lf"
            })).formatted + "}"),
                  s = [{
            ...
            for (const {
              cells: e
            } of p.filter(e => !e.hasLineBreak)) e.forEach((e, t) => {
  ...
  const {
    ...
    utils: {
      mapDoc: Ml,
      replaceNewlinesWithLiterallines: jl
    }
  } = cn,
        {
    printTemplateExpressions: _l
  } = Fl;
  ...
  const {
    builders: {
      ...
      concat: Wl
        ...
        {
    escapeTemplateCharacters: Ul,
    printTemplateExpressions: Jl
  } = Fl;
  ...
  const {
    ...
    utils: {
      mapDoc: Zl
        ...
        {
    printTemplateExpressions: ep,
    uncookTemplateElementValue: tp
  } = Fl;
  let np = 0;
  ...
  var pp = function (e, t, n, r) {
    const o = e.getValue();
    if ("TemplateLiteral" !== o.type || function ({
      quasis: e
    }) {
      return e.some(({
        value: {
  ...
  var yp = je(function (e, t) {
    ...
    Object.defineProperty(t, "__esModule", {
      ...
      return f(e).pragmas;
    }, t.parseWithComments = f, t.print = function ({
      comments: e = "",
      pragmas: t = {}
    }) {
      const o = (0, r().default)(e) || n().EOL,
            u = " *",
            i = Object.keys(t),
            a = i.map(e => h(e, t[e])).reduce((e, t) => e.concat(t), []).map(e => " * " + e + o).join("");
  ...
  const {
    getFunctionParameters: wp,
    getLeftSidePathName: Tp,
    hasFlowShorthandAnnotationComment: Bp,
    hasNakedLeftSide: Np,
    hasNode: kp,
    isBitwiseOperator: Pp,
    startsWithNoLookaheadToken: Op,
    shouldFlatten: Ip,
    getPrecedence: Lp
  } = wc;
  ...
  var zp = {
    ...
    printHtmlBinding: function (e, t, n) {
      ...
      if (t.__onHtmlBindingRoot && null === e.getName() && t.__onHtmlBindingRoot(r, t), "File" === r.type) return t.__isVueForBindingLeft ? e.call(e => {
        const t = $p(Vp([",", qp]), e.map(n, "params")),
              {
          params: r
        } = e.getValue();
  ...
  const {
    builders: {
      ...
      hardline: Zp
        ...
        {
    hasNewlineBetweenOrAfterDecorators: ed,
    getParentExportDeclaration: td
  } = wc;
  var nd = {
  ...
  const {
    builders: {
      ...
      hardline: ld
        ...
        {
    printDanglingComments: pd
  } = Fa,
        {
    hasDanglingComments: dd,
    shouldPrintComma: fd,
    needsHardlineAfterDanglingComment: hd
  } = wc,
        {
    locStart: md,
    hasSameLoc: gd
  ...
  var Md = function (e, t, n, r) {
    ...
    if (r.shouldCheckJsx && (Ad(o[r.testNodePropertyNames[0]]) || Ad(u) || Ad(i) || function (e) {
      ...
      const t = e => wd([Od("(", ""), kd(wd([Bd, e])), Bd, Od(")", "")]),
    ...
    const D = Yu([...r.testNodePropertyNames.map(e => o[e].comments), u.comments, i.comments]).filter(Boolean).some(e => Fd(e) && vd(t.originalText, xd(e), Sd(e))),
  ...
  const {
    getNextNonSpaceNonCommentCharacter: jd,
    isNextLineEmpty: _d
  } = Lt,
        {
    printDanglingComments: Rd
  } = Fa,
        {
    builders: {
      concat: Vd,
    ...
    utils: {
      removeLines: Hd
        ...
        {
    getFunctionParameters: Gd,
    iterateFunctionParametersPath: Xd,
    isSimpleType: Yd,
    isTestCall: Kd,
    isTypeAnnotationAFunction: Qd,
    isObjectType: Zd,
    isObjectTypePropertyAFunction: ef,
    hasRestParameter: tf,
    shouldPrintComma: nf
  } = wc,
        {
    locEnd: rf
        ...
        {
    printFunctionTypeParameters: of
  } = nd;
  ...
  const {
    ...
    locEnd: Ff
        ...
        {
    printOptionalToken: xf
  } = nd,
        {
    printTypeAnnotation: Sf
  } = df;
  ...
  var Tf = {
    printArray: function (e, t, n) {
      ...
      if (0 === r.elements.length) vf(r) ? o.push(Df(hf([u, ff(e, t), gf, "]"]))) : o.push(u, "]");else {
        const i = Cf(r.elements),
              a = !(i && "RestElement" === i.type),
              s = a && null === i,
              c = !t.__inJestEach && r.elements.length > 1 && r.elements.every((e, t, n) => {
          const r = e && e.type;
  ...
  const {
    ...
    getLast: jf,
    isNextLineEmpty: _f,
    hasNewlineInRange: Rf,
    hasNewline: Vf
  } = Lt,
        {
    hasDanglingComments: $f,
    shouldPrintComma: qf,
    hasNodeIgnoreComment: Wf,
    isBlockComment: Uf
  } = wc,
        {
    locStart: Jf,
    locEnd: zf
        ...
        {
    printOptionalToken: Hf
  } = nd,
        {
    shouldHugFunctionParameters: Gf
  } = af,
        {
    printTypeAnnotation: Xf,
    shouldHugType: Yf
  } = df;
  var Kf = {
    printObject: function (e, t, n) {
      ...
      if (o.inexact) {
        ...
        if ($f(o)) {
          const r = !o.comments.every(e => Uf(e)),
                u = Bf(e, t, !0);
  ...
  const {
    ...
    utils: {
      ...
      isEmpty: dh
        ...
        {
    getLast: fh,
    getPreferredQuote: hh
  } = Lt,
        {
    hasTrailingComment: mh,
    isEmptyJSXElement: gh,
    isJSXWhitespaceExpression: Dh,
    isJSXNode: yh,
    isMeaningfulJSXText: Eh,
    matchJsxWhitespaceRegex: Ch,
    rawText: bh,
    isLiteral: vh,
    isCallOrOptionalCallExpression: Ah,
    isStringLiteral: Fh,
    isBinaryish: xh,
    isBlockComment: Sh
  } = wc,
        {
    willPrintOwnComments: wh
  } = il;
  ...
  function Th(e, t, n) {
    ...
    const i = r.children.filter(yh).length > 0,
    ...
    const l = "mdx" === e.getParentNode().rootMarker,
      ...
      return e.each((e, t) => {
        ...
        if (vh(a)) {
          ...
          m = r.children.some(e => Eh(e));

    for (let e = h.length - 2; e >= 0; e--) {
      const t = "" === h[e] && "" === h[e + 1],
            n = h[e] === nh && "" === h[e + 1] && h[e + 2] === nh,
            r = (h[e] === rh || h[e] === nh) && "" === h[e + 1] && h[e + 2] === d,
            o = h[e] === d && "" === h[e + 1] && (h[e + 2] === rh || h[e + 2] === nh),
            u = h[e] === d && "" === h[e + 1] && h[e + 2] === d,
            i = h[e] === rh && "" === h[e + 1] && h[e + 2] === nh || h[e] === nh && "" === h[e + 1] && h[e + 2] === rh;
  ...
  var Ph = {
    printJsxElement: function (e, t, n) {
      ...
      return function (e, t, n) {
        ...
        const o = e.match(void 0, e => "ArrowFunctionExpression" === e.type, Ah, e => "JSXExpressionContainer" === e.type),
              u = Rp(e, n);
    ...
    printJsxOpeningElement: function (e, t, n) {
      ...
      const u = r.attributes.length && mh(fh(r.attributes)),
            i = !r.attributes.length && !o || t.jsxBracketSameLine && (!o || r.attributes.length) && !u,
            a = r.attributes && r.attributes.some(e => e.value && Fh(e.value) && e.value.value.includes("\n"));
    ...
    printJsxEmptyExpression: function (e, t) {
      const n = e.getValue(),
            r = n.comments && !n.comments.every(e => Sh(e));
  ...
  function Xh(e, t) {
    const n = e.getValue();
    if (!qh(n)) return "";
    const r = n.comments.every(e => Uh(e)),
          o = Oh(e, t, r);
    return r ? o : Ih([o, jh]);
  }
  ...
  const {
    printDanglingComments: sm
  } = Fa,
        {
    getNextNonSpaceNonCommentCharacterIndex: cm
  } = Lt,
        {
    builders: {
      concat: lm,
      ...
      hardline: gm
        ...
        {
    getFunctionParameters: Dm,
    hasDanglingComments: ym,
    hasLeadingOwnLineComment: Em,
    isFlowAnnotationComment: Cm,
    isJSXNode: bm,
    isTemplateOnItsOwnLine: vm,
    shouldPrintComma: Am,
    startsWithNoLookaheadToken: Fm,
    returnArgumentHasLeadingComment: xm,
    isBinaryish: Sm,
    isLineComment: wm
  } = wc,
        {
    locEnd: Tm
        ...
        {
    printFunctionParameters: Bm
  } = af,
        {
    printPropertyKey: Nm
  } = am,
        {
    printFunctionTypeParameters: km
  } = nd;
  ...
  const {
    ...
    builders: {
      ...
      ifBreak: Jm
        ...
        {
    hasTrailingComment: zm,
    hasTrailingLineComment: Hm
  } = wc,
        {
    getTypeParametersGroupId: Gm
  } = Yh,
        {
    printMethod: Xm
  } = Lm,
  ...
  var eg = {
    printClass: function (e, t, n) {
      ...
      const u = r.id && zm(r.id) || r.superClass && r.superClass.comments && 0 !== r.superClass.comments.length || r.extends && 0 !== r.extends.length || r.mixins && 0 !== r.mixins.length || r.implements && 0 !== r.implements.length,
            i = [],
            a = [];

      if (r.id && i.push(" ", e.call(n, "id")), i.push(e.call(n, "typeParameters")), r.superClass) {
        const r = _m(["extends ", Zm(e, t, n), e.call(n, "superTypeParameters")]),
              o = e.call(e => Mm(e, () => r, t), "superClass");
  ...
  const {
    ...
    isNextLineEmpty: rg
        ...
        {
    getFunctionParameters: og,
    iterateFunctionParametersPath: ug,
    hasLeadingComment: ig,
    hasTrailingComment: ag,
    isFunctionCompositionArgs: sg,
    isJSXNode: cg,
    isLongCurriedCallExpression: lg,
    shouldPrintComma: pg,
    getCallArguments: dg,
    iterateCallArgumentsPath: fg
  } = wc,
        {
    locEnd: hg
  } = ii,
  ...
  const {
    getLast: Lg,
    isNextLineEmpty: Mg,
    isNextLineEmptyAfterIndex: jg,
    getNextNonSpaceNonCommentCharacterIndex: _g
  } = Lt,
        {
    hasLeadingComment: Rg,
    hasTrailingComment: Vg,
    isCallOrOptionalCallExpression: $g,
    isFunctionOrArrowExpression: qg,
    isLongCurriedCallExpression: Wg,
    isMemberish: Ug,
    isNumericLiteral: Jg,
    isSimpleCallArgument: zg
  } = wc,
        {
    locEnd: Hg
  } = ii,
    ...
    utils: {
      willBreak: tD
        ...
        {
    printMemberLookup: nD
  } = Ig,
        {
    printOptionalToken: rD,
    printFunctionTypeParameters: oD,
    printBindExpressionCallee: uD
  } = nd;
  ...
  var iD = function (e, t, n) {
    ...
    const g = c.map(m),
          ...
          y = h ? 3 : 2,
          E = Yu(c),
          C = E.slice(1, -1).some(e => Rg(e.node)) || E.slice(0, -1).some(e => Vg(e.node)) || c[y] && Rg(c[y][0].node);
    if (c.length <= y && !C) return Wg(e) ? D : Kg(D);
    const b = Lg(c[h ? 1 : 0]).node,
          v = !$g(b) && i(b),
  ...
  const {
    builders: {
      ...
      group: cD
        ...
        {
    getCallArguments: lD,
    hasFlowAnnotationComment: pD,
    isCallOrOptionalCallExpression: dD,
    isMemberish: fD,
    isTemplateOnItsOwnLine: hD,
    isTestCall: mD,
    iterateCallArgumentsPath: gD
  } = wc,
        {
    printOptionalToken: DD,
    printFunctionTypeParameters: yD
  } = nd;
  var ED = {
  ...
  const {
    builders: {
      ...
      ifBreak: xD
        ...
        {
    hasTrailingComment: SD,
    hasTrailingLineComment: wD,
    identity: TD
  } = wc,
        {
    getTypeParametersGroupId: BD
  } = Yh,
        {
    printTypeScriptModifiers: ND
  } = nd;
  var kD = {
  ...
  function XD(e, t, n, r, o) {
    ...
    if (JD(i)) {
      ...
      const a = YD(i),
            ...
            l = "NGPipeExpression" === i.type && 0 !== i.arguments.length ? _D(RD(ID([jD, ": ", LD(ID([jD, ":", $D(" ")]), e.map(t, "arguments").map(e => VD(2, _D(e))))]))) : "",
            p = ID(a ? [c, " ", e.call(t, "right"), l] : [s ? MD : "", c, s ? " " : MD, e.call(t, "right"), l]),
            d = e.getParentNode(),
            f = UD(i.left),
  ...
  const {
    builders: {
      ...
      indent: ty
        ...
        {
    hasLeadingOwnLineComment: ny,
    isBinaryish: ry,
    isMemberExpressionChain: oy,
    isStringLiteral: uy
  } = wc,
        {
    shouldInlineLogicalExpression: iy
  } = KD;
  ...
  const {
    ...
    builders: {
      ...
      hardline: fy
        ...
        {
    classChildNeedsASIProtection: hy,
    classPropMayCauseASIProblems: my,
    getLeftSidePathName: gy,
    hasNakedLeftSide: Dy,
    isJSXNode: yy,
    isLastStatement: Ey,
    isTheOnlyJSXElementInMarkdown: Cy
  } = wc,
        {
    locEnd: by
  } = ii,
        {
    shouldPrintParamsWithoutParens: vy
  } = Lm;
  ...
  const {
    ...
    builders: {
      ...
      indent: Ny
        ...
        {
    hasDanglingComments: ky
  } = wc,
        {
    locEnd: Py
  } = ii,
        {
    printStatementSequence: Oy
  } = xy;
  var Iy = {
  ...
  const {
    ...
    insertPragma: sE
        ...
        {
    printHtmlBinding: cE,
    isVueEventBindingExpression: lE
  } = zp,
        {
    getFunctionParameters: pE,
    getCallArguments: dE,
    getParentExportDeclaration: fE,
    getTypeScriptMappedTypeModifier: hE,
    hasDanglingComments: mE,
    hasFlowShorthandAnnotationComment: gE,
    hasLeadingOwnLineComment: DE,
    hasNewlineBetweenOrAfterDecorators: yE,
    hasNgSideEffect: EE,
    hasPrettierIgnore: CE,
    hasTrailingComment: bE,
    isExportDeclaration: vE,
    isFunctionNotation: AE,
    isGetterOrSetter: FE,
    isLiteral: xE,
    isNgForOf: SE,
    isObjectType: wE,
    isObjectTypePropertyAFunction: TE,
    isTheOnlyJSXElementInMarkdown: BE,
    isTSXFile: NE,
    isBlockComment: kE,
    ...
    locEnd: ME
        ...
        {
    printOptionalToken: jE,
    printBindExpressionCallee: _E,
    printTypeScriptModifiers: RE,
    printDecorators: VE,
    printFlowDeclaration: $E,
    adjustClause: qE
  } = nd,
        {
    printImportDeclaration: WE,
    printExportDeclaration: UE,
    printExportAllDeclaration: JE,
    printModuleSpecifier: zE
  } = bd,
        {
    printFunctionParameters: HE
  } = af,
        {
    printTemplateLiteral: GE
  } = Fl,
        {
    printArray: XE,
    printArrayItems: YE
    ...
    printObject: KE
        ...
        {
    printTypeAnnotation: QE,
    shouldHugType: ZE
  } = df,
        {
    printJsxElement: eC,
    printJsxAttribute: tC,
    printJsxOpeningElement: nC,
    printJsxClosingElement: rC,
    printJsxOpeningClosingFragment: oC,
    printJsxExpressionContainer: uC,
    printJsxEmptyExpression: iC,
    printJsxSpreadAttribute: aC,
    printJsxSpreadChild: sC
  } = Ph,
        {
    printClass: cC,
    printClassMethod: lC
        ...
        {
    printTypeParameters: pC
  } = Yh,
        {
    printPropertyKey: dC
  } = am,
        {
    printFunctionDeclaration: fC,
    printArrowFunctionExpression: hC,
    printMethod: mC,
    printReturnAndThrowArgument: gC
  } = Lm,
        {
    printCallExpression: DC
  } = ED,
        {
    printInterface: yC
  } = kD,
        {
    printVariableDeclarator: EC,
    printAssignmentExpression: CC,
    printAssignment: bC,
    printAssignmentRight: vC
  } = cy,
        {
    printBinaryishExpression: AC
  } = KD,
        {
    printStatementSequence: FC
  } = xy,
        {
    printMemberExpression: xC
  } = Ig,
        {
    printBlock: SC
  } = Iy,
    ...
    print: function (e, t, n, r) {
      ...
      const i = function (e, t, n, r) {
        ...
        switch (o.type) {
          ...
          case "Program":
            {
              const r = !o.body.every(({
                type: e
              }) => "EmptyStatement" === e) || o.comments;
          ...
          case "TSTypeAssertion":
            {
              const t = !("ArrayExpression" === o.expression.type || "ObjectExpression" === o.expression.type),
                    r = nE(Yy(["<", rE(Yy([eE, e.call(n, "typeAnnotation")])), eE, ">"])),
                    u = Yy([iE("("), rE(Yy([eE, e.call(n, "expression")])), eE, iE(")")]);
          ...
          case "IfStatement":
            {
              const r = qE(o.consequent, e.call(n, "consequent")),
                    u = nE(Yy(["if (", nE(Yy([rE(Yy([eE, e.call(n, "test")])), eE])), ")", r]));

              if (a.push(u), o.alternate) {
                const r = bE(o.consequent) && o.consequent.comments.some(e => e.trailing && !kE(e)) || PE(o),
          ...
          case "ForStatement":
            {
              const r = qE(o.body, e.call(n, "body")),
                    u = Fa.printDanglingComments(e, t, !0),
                    i = u ? Yy([u, eE]) : "";
          ...
          case "DoWhileStatement":
            {
              const t = qE(o.body, e.call(n, "body")),
                    r = nE(Yy(["do", t]));
          ...
          case "TupleTypeAnnotation":
            {
              const r = "TSTupleType" === o.type ? "elementTypes" : "types",
                    u = o[r].length > 0 && "TSRestType" === zy(o[r]).type;
          ...
          case "TSFunctionType":
            {
              const r = e.getParentNode(0),
                    u = e.getParentNode(1),
                    i = e.getParentNode(2);
              let s = "TSFunctionType" === o.type || !(("ObjectTypeProperty" === r.type || "ObjectTypeInternalSlot" === r.type) && !r.variance && !r.optional && LE(r) === LE(o) || "ObjectTypeCallProperty" === r.type || i && "DeclareFunction" === i.type),
          ...
          case "UnionTypeAnnotation":
            {
              ...
              if (i) return Ky(" | ", a);
              const s = u && !DE(t.originalText, o),
                    c = Yy([iE(Yy([s ? Qy : "", "| "])), Ky(Yy([Qy, "| "]), a)]);
          ...
          case "TSIndexSignature":
            {
              const r = e.getParentNode(),
                    i = o.parameters.length > 1 ? iE(IE(t) ? "," : "") : "",
                    a = nE(Yy([rE(Yy([eE, Ky(Yy([", ", eE]), e.map(n, "parameters"))])), i, eE]));
          ...
          case "NGMicrosyntaxKeyedExpression":
            {
              const t = e.getName(),
                    r = e.getParentNode(),
                    u = SE(o, t, r) || (1 === t && ("then" === o.key.name || "else" === o.key.name) || 2 === t && "else" === o.key.name && "NGMicrosyntaxKeyedExpression" === r.body[t - 1].type && "then" === r.body[t - 1].key.name) && "NGMicrosyntaxExpression" === r.body[0].type;
  ...
  var ob = {
    parse: function (e) {
      const t = Object.keys(rb).map(ae).join("|"),
  ...
  const {
    ...
    insertPragma: Hb
        ...
        {
    getAncestorNode: Gb,
    getPropOfDeclNode: Xb,
    maybeToLowerCase: Yb,
    insideValueFunctionNode: Kb,
    insideICSSRuleNode: Qb,
    insideAtRuleNode: Zb,
    insideURLFunctionInImportAtRuleNode: ev,
    isKeyframeAtRuleKeywords: tv,
    isWideKeywords: nv,
    isSCSS: rv,
    isLastNode: ov,
    isLessParser: uv,
    isSCSSControlDirectiveNode: iv,
    isDetachedRulesetDeclarationNode: av,
    isRelationalOperatorNode: sv,
    isEqualityOperatorNode: cv,
    isMultiplicationNode: lv,
    isDivisionNode: pv,
    isAdditionNode: dv,
    isSubtractionNode: fv,
    isMathOperatorNode: hv,
    isEachKeywordNode: mv,
    isForKeywordNode: gv,
    isURLFunctionNode: Dv,
    isIfElseKeywordNode: yv,
    hasComposesNode: Ev,
    hasParensAroundNode: Cv,
    hasEmptyRawBefore: bv,
    isKeyValuePairNode: vv,
    isDetachedRulesetCallNode: Av,
    isTemplatePlaceholderNode: Fv,
    isTemplatePropNode: xv,
    isPostcssSimpleVarNode: Sv,
    isSCSSMapItemNode: wv,
    isInlineValueCommentNode: Tv,
    isHashNode: Bv,
    isLeftCurlyBraceNode: Nv,
    isRightCurlyBraceNode: kv,
    isWordNode: Pv,
    isColonNode: Ov,
    isMediaAndSupportsKeywords: Iv,
    isColorAdjusterFuncNode: Lv,
    lastLineHasInlineComment: Mv,
    isAtWordPlaceholderNode: jv
  } = bb,
        {
    locStart: _v,
    locEnd: Rv
    ...
    print: function (e, t, n) {
      ...
      switch (r.type) {
        ...
        case "css-comment":
          {
            const e = r.inline || r.raws.inline,
                  n = t.originalText.slice(_v(r), Rv(r));
        ...
        case "css-atrule":
          {
            const o = e.getParentNode(),
                  u = Fv(r) && !o.raws.semicolon && ";" !== t.originalText[Rv(r) - 1];
        ...
        case "selector-combinator":
          {
            if ("+" === r.value || ">" === r.value || "~" === r.value || ">>>" === r.value) {
              const t = e.getParentNode(),
                    n = "selector-selector" === t.type && t.nodes[0] === r ? "" : jb;
              return Lb([n, r.value, ov(e, r) ? "" : " "]);
            }

            const n = r.value.trim().startsWith("(") ? jb : "",
                  o = zv(Uv(r.value.trim(), t)) || jb;
            return Lb([n, o]);
          }
        ...
        case "value-comma_group":
          {
            ...
            for (let n = 0; n < r.groups.length; ++n) {
              ...
              const b = (dv(h) || fv(h)) && 0 === n && ("value-number" === m.type || m.isHex) && o && Lv(o) && !bv(m),
                    v = g && "value-func" === g.type || g && Pv(g) || "value-func" === h.type || Pv(h),
                    A = "value-func" === m.type || Pv(m) || u && "value-func" === u.type || u && Pv(u);
  ...
  const {
    ...
    getNextNode: bA,
    getPreviousNode: vA,
    hasPrettierIgnore: AA,
    isNextNodeOfSomeType: FA,
    isNodeOfSomeType: xA,
    isParentOfSomeType: SA,
    isPreviousNodeOfSomeType: wA,
    isVoid: TA,
    isWhitespaceNode: BA
  } = lA;
    ...
    print: function (e, t, n) {
      ...
      switch (r.type) {
        ...
        case "MustacheStatement":
          {
            const t = SA(e, ["AttrNode", "ConcatStatement"]),
                  o = SA(e, ["ElementNode"]) && 0 === r.hash.pairs.length && function (e) {
  ...
  var RF = {
    ...
    hasGitDiffFriendlyOrderedList: function (e, t) {
      ...
      const n = Number(_F(e.children[0], t.originalText).numberText),
  ...
  const {
    ...
    utils: {
      replaceNewlinesWithLiterallines: JF
    }
  } = cn,
        {
    print: zF
    ...
    if ("code" === o.type && null !== o.lang) {
      ...
      if (e) {
        const t = r.__inJsTemplate ? "~" : "`",
              u = t.repeat(Math.max(3, $F(o.value, t) + 1)),
              i = n(HF(o, r.originalText), {
          parser: e
        }, {
          stripTrailingHardline: !0
        });
  ...
  const {
    getLast: lx,
    getMinNotPresentContinuousCount: px,
    getMaxContinuousCount: dx,
    getStringWidth: fx
  } = Lt,
        {
    builders: {
    ...
    locEnd: Px
        ...
        {
    getFencedCodeBlockValue: Ox,
    hasGitDiffFriendlyOrderedList: Ix,
    splitText: Lx,
    punctuationPattern: Mx,
    INLINE_NODE_TYPES: jx,
    INLINE_NODE_WRAPPER_TYPES: _x,
    isAutolink: Rx
  } = RF,
    ...
    return e.each((e, n) => {
      ...
      if (!1 !== o) {
        ...
        (function (e, t) {
          ...
          const n = (t.prevNode && t.prevNode.type) === e.type && qx.has(e.type),
    ...
    print: function (e, t, n) {
      ...
      switch (r.type) {
        ...
        case "code":
          {
            ...
            const e = t.__inJsTemplate ? "~" : "`",
                  n = e.repeat(Math.max(3, dx(r.value, e) + 1));
        ...
        case "html":
          {
            const t = e.getParentNode(),
                  n = "root" === t.type && lx(t.children) === r ? r.value.trimEnd() : r.value,
                  o = /^<!--[\S\s]*-->$/.test(n);
        ...
        case "table":
          return function (e, t, n) {
            const r = Cx.parts[0],
                  ...
                  u = [],
                  i = e.map(e => e.map((e, r) => {
              const o = Tx(e.call(n), t).formatted,
                    i = fx(o);
  ...
  const {
    inferParserByLanguage: lS,
    isFrontMatterNode: pS
  } = Lt,
        {
    CSS_DISPLAY_TAGS: dS,
    CSS_DISPLAY_DEFAULT: fS,
    CSS_WHITE_SPACE_TAGS: hS,
    CSS_WHITE_SPACE_DEFAULT: mS
  } = {
    CSS_DISPLAY_TAGS: {
      area: "none",
      base: "none",
  ...
  var $S = {
    ...
    t.ParseError = class {
      ...
      const u = JS.identifierModuleUrl(t),
  ...
  const {
    ParseSourceSpan: HS
        ...
        {
    htmlTrim: GS,
    getLeadingAndTrailingHtmlWhitespace: XS,
    hasHtmlWhitespace: YS,
    canHaveInterpolation: KS,
    getNodeCssStyleDisplay: QS,
    isDanglingSpaceSensitiveNode: ZS,
    isIndentationSensitiveNode: ew,
    isLeadingSpaceSensitiveNode: tw,
    isTrailingSpaceSensitiveNode: nw,
    isWhitespaceSensitiveNode: rw
  } = $S,
        ow = [function (e) {
    return e.map(e => {
        ...
        if (n.some(Boolean)) {
          ...
          for (let r = 0; r < e.children.length; r++) {
            ...
            if (!n[r + 1]) if (n[r]) {
              const e = o.prev,
                    n = o.firstChild,
                    r = new HS(e.sourceSpan.start, n.sourceSpan.end),
                    u = new HS(r.start, o.sourceSpan.end);
              t.push(o.clone({
  ...
  var gw = {
    printImgSrcset: function (e) {
      ...
      if (n + r + t.some(({
        d: e
      }) => e) > 1) throw new Error("Mixed descriptor in srcset is not supported");
  ...
  const {
    ...
    softline: Pw
        ...
        {
    htmlTrimPreserveIndentation: Ow,
    splitByHtmlWhitespace: Iw,
    countChars: Lw,
    countParents: Mw,
    dedentString: jw,
    forceBreakChildren: _w,
    forceBreakContent: Rw,
    forceNextEmptyLine: Vw,
    getLastDescendant: $w,
    getPrettierIgnoreAttributeCommentData: qw,
    hasPrettierIgnore: Ww,
    inferScriptParser: Uw,
    isVueCustomBlock: Jw,
    isVueNonHtmlBlock: zw,
    isVueSlotAttribute: Hw,
    isVueSfcBindingsAttribute: Gw,
    isScriptLikeTag: Xw,
    isTextLikeNode: Yw,
    preferHardlineAsLeadingSpaces: Kw,
    shouldNotPrintClosingTag: Qw,
    shouldPreserveContent: Zw,
    unescapeQuoteEntities: eT,
    isPreLikeNode: tT
  } = $S,
        {
    insertPragma: nT
    ...
    printVueFor: uT,
    printVueBindings: iT,
    isVueEventBindingExpression: aT
  } = lw,
        {
    printImgSrcset: sT,
    printClassNames: cT
  ...
  function fT(e, t, n) {
    ...
    const o = r.prev && "comment" === r.prev.type && qw(r.prev.value),
            ...
            const e = function (e, t, n) {
              ...
              const i = (e, t) => {
                ...
                !n || "ObjectExpression" !== n.type && "ArrayExpression" !== n.type && ("__vue_expression" !== t.parser || "TemplateLiteral" !== n.type && "StringLiteral" !== n.type) || (u = !0);
                    ...
                    a = e => xw(e),
                    s = (e, t = !0) => xw(lT([Tw(lT([Pw, e])), t ? Pw : ""])),
                    c = e => u ? a(e) : s(e),
                    l = (e, n) => t(e, Object.assign({
  ...
  var YT = {
    ...
    getBlockValueLineContents: function (e, {
      parentIndent: t,
      isLastDescendant: n,
      options: r
    }) {
  ...
  const KT = cn.builders,
    ...
    softline: dB
        ...
        {
    replaceEndOfLineWith: fB,
    isPreviousLineEmpty: hB
  } = Lt,
        {
    insertPragma: mB,
    isPragma: gB
    ...
    locStart: DB
        ...
        {
    getAncestorCount: yB,
    getBlockValueLineContents: EB,
    getFlowScalarLineContents: CB,
    getLast: bB,
    getLastDescendantNode: vB,
    hasLeadingComments: AB,
    hasMiddleComments: FB,
    hasIndicatorComment: xB,
    hasTrailingComment: SB,
    hasEndComments: wB,
    hasPrettierIgnore: TB,
    isLastDescendantNode: BB,
    isNextLineEmpty: NB,
    isNode: kB,
    isEmptyNode: PB,
    defineShortcut: OB,
  ...
  function MB(e, t, n, r, o) {
    switch (e.type) {
      ...
      case "documentBody":
        {
          const t = aB(uB, n.map(o, "children")).parts,
                r = aB(uB, n.map(o, "endComments")).parts,
                u = 0 === t.length || 0 === r.length ? "" : (e => kB(e, ["blockFolded", "blockLiteral"]) ? "keep" === e.chomping ? "" : eB([uB, uB]) : uB)(vB(e));
      ...
      case "blockLiteral":
        {
          const t = yB(n, e => kB(e, ["sequence", "mapping"])),
                u = BB(n);
      ...
      case "flowSequence":
        {
          const t = "flowMapping" === e.type ? "{" : "[",
                ...
                s = "flowMapping" === e.type && 0 !== e.children.length && r.bracketSpacing ? sB : dB,
                c = 0 !== e.children.length && "flowMappingItem" === (u = bB(e.children)).type && PB(u.key) && PB(u.value),
                l = "none" === r.trailingComma ? "" : iB(",", "");
